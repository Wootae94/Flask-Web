...
@regression_bp.before_app_first_request
...
@regression_bp.route('/stock', methods=['GET', 'POST'])
def stock():
    menu = {'ho':0, 'da':0, 'ml':1, 'sc':0, 'co':0, 'ca':0, 'cr':0, 'wc':0, 'clf':0, 'cl_clf':0, 'rg':1}
    if request.method == 'GET':
        return render_template('regression/stock.html', menu=menu, weather=get_weather_main(),
